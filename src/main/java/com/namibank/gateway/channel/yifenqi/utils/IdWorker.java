...
public class IdWorker {
	...
	public String get8IdToString() {
		DecimalFormat decimalFormat = new DecimalFormat("########");
		decimalFormat.setMaximumIntegerDigits(8);
		return decimalFormat.format(this.nextId());
	}

	public static void main(String[] args) {
		IdWorker id = new IdWorker(2, 10);
		for (int i = 0; i < 10; i++) {
			// long ss = id.nextId();
			// System.out.println(ss);
			// String s = decimalFormat.format(ss);
			System.out.println(id.get8IdToString());
		}
	}
